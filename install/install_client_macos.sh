...
MACOS_RELEASE_URL="https://github.com/coolcoder067/TCP-VPN_Mac/releases/download/dev-20251223-0/client-macos.tar.gz"
...
if [[ -d ~/Library/Application\ Support/tcpvpn ]]; then
	...
	echo "Do you want to proceed? Press Enter to continue, or Ctrl+C to quit."
	read
else 
